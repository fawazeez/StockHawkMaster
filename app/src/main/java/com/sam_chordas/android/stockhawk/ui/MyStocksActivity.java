    ...
    recyclerView.addOnItemTouchListener(new RecyclerViewItemClickListener(this,
            new RecyclerViewItemClickListener.OnItemClickListener() {
              ...
              Intent chartIntent = new Intent(mContext,ChartActivity.class);
                ...
                chartIntent.putExtra("symbol",mCursor.getString(mCursor.getColumnIndex("symbol")));
          ...
          new MaterialDialog.Builder(mContext).title(R.string.symbol_search)
              ...
              .input(R.string.input_hint, R.string.input_prefill, new MaterialDialog.InputCallback() {
                @Override public void onInput(MaterialDialog dialog, CharSequence input) {
                  ...
                  if (c.getCount() != 0) {
                    Toast toast =
                        Toast.makeText(MyStocksActivity.this, getString(R.string.stock_exist),
                            Toast.LENGTH_LONG);
                    ...
                    startService(mServiceIntent);
                      ...
                      ComponentName componentName = new ComponentName(mContext,StockHawkWidget.class);
